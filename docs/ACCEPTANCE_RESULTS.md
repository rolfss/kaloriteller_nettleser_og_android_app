...
- The public application exposes Android installation from the primary navigation. Automated UI tests verify the direct APK link, Chrome fallback instructions, and native `beforeinstallprompt` handling; the installed/native state hides redundant download actions.
