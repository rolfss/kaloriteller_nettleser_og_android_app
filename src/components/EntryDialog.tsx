      ...
      <form onSubmit={submit}>
        ...
        {!confirmDelete ? (
          ...
          <div className="inline-confirm" role="alert">
            <p>Slette innlegget? Du kan angre i ti sekunder.</p>
            <div className="modal__actions">
              <button type="button" className="button button--secondary" disabled={busy} onClick={() => setConfirmDelete(false)}>Behold</button>
              <button type="button" className="button button--danger-quiet" disabled={busy} onClick={() => { void onDelete() }}>Slett innlegg</button>
            </div>
          </div>
        )}
      </form>
